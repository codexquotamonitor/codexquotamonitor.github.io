...
const CQM_T = {
  ...
  en: {
    ...
    preview_sub: 'See how Codex Quota Monitor looks in the browser and Chrome Web Store assets.',
    preview_slide1_title: 'Popup overview',
    preview_slide2_title: 'Light theme',
    preview_slide3_title: 'Store marquee',
    preview_slide_placeholder: 'Screenshot preview',
    preview_slide4_desc: 'Compact Chrome Web Store artwork for the extension listing.',
    preview_slide4_title: 'Small tile',
    preview_slide3_desc: 'A wide preview showing the extension identity and usage popup.',
    ...
    preview_slide5_title: 'Store screenshot',
    preview_slide5_desc: 'A Chrome Web Store screenshot showing the popup and quota details.',
    preview_slide6_title: 'X banner',
    preview_slide6_desc: 'Social banner artwork using the Codex Quota Monitor identity.',
    preview_slide7_title: 'YouTube banner',
    preview_slide7_desc: 'Wide channel banner prepared for future video and community updates.',
    preview_slide8_title: 'YouTube thumbnail',
    preview_slide8_desc: 'Thumbnail artwork for future walkthroughs and release videos.',
  ...
  pt_BR: {
    ...
    preview_sub: 'Veja como o Codex Quota Monitor aparece no navegador e nos materiais da Chrome Web Store.',
    preview_slide1_title: 'Visão geral do popup',
    preview_slide2_title: 'Tema claro',
    preview_slide3_title: 'Letreiro da loja',
    preview_slide_placeholder: 'Prévia de captura de tela',
    preview_slide4_desc: 'Arte compacta para a página da extensão na Chrome Web Store.',
    preview_slide4_title: 'Bloco pequeno',
    preview_slide3_desc: 'Uma prévia ampla mostrando a identidade da extensão e o popup de uso.',
    ...
    preview_slide5_title: 'Screenshot da loja',
    preview_slide5_desc: 'Uma captura da Chrome Web Store mostrando o popup e os detalhes de cota.',
    preview_slide6_title: 'Banner do X',
    preview_slide6_desc: 'Arte para redes sociais usando a identidade do Codex Quota Monitor.',
    preview_slide7_title: 'Banner do YouTube',
    preview_slide7_desc: 'Banner amplo de canal preparado para futuros vídeos e atualizações da comunidade.',
    preview_slide8_title: 'Miniatura do YouTube',
    preview_slide8_desc: 'Arte de miniatura para futuros tutoriais e vídeos de lançamento.',
  ...
  es: {
    ...
    preview_title: 'Preview',
    preview_sub: 'Mira cómo se ve Codex Quota Monitor en el navegador y en los recursos de Chrome Web Store.',
    preview_slide1_title: 'Vista general del popup',
    preview_slide2_title: 'Tema claro',
    preview_slide3_title: 'Marquesina de la tienda',
    preview_slide_placeholder: 'Vista previa de captura',
    preview_slide4_desc: 'Arte compacta para la ficha de la extensión en Chrome Web Store.',
    preview_slide4_title: 'Bloque pequeño',
    preview_slide3_desc: 'Una vista amplia con la identidad de la extensión y el popup de uso.',
    ...
    preview_slide5_title: 'Captura de la tienda',
    preview_slide5_desc: 'Una captura de Chrome Web Store que muestra el popup y los detalles de cuota.',
    preview_slide6_title: 'Banner de X',
    preview_slide6_desc: 'Arte para redes sociales con la identidad de Codex Quota Monitor.',
    preview_slide7_title: 'Banner de YouTube',
    preview_slide7_desc: 'Banner ancho de canal preparado para futuros videos y actualizaciones de la comunidad.',
    preview_slide8_title: 'Miniatura de YouTube',
    preview_slide8_desc: 'Arte de miniatura para futuros tutoriales y videos de lanzamiento.',
  ...
  fr: {
    ...
    preview_title: 'Preview',
    preview_sub: 'Découvrez l’apparence de Codex Quota Monitor dans le navigateur et dans les visuels du Chrome Web Store.',
    preview_slide1_title: 'Aperçu du popup',
    preview_slide2_title: 'Thème clair',
    preview_slide3_title: 'Bannière de la boutique',
    preview_slide_placeholder: 'Aperçu de capture',
    preview_slide4_desc: 'Visuel compact pour la fiche de l’extension dans le Chrome Web Store.',
    preview_slide4_title: 'Petit bloc',
    preview_slide3_desc: 'Un aperçu large montrant l’identité de l’extension et le popup d’utilisation.',
    ...
    preview_slide5_title: 'Capture de la boutique',
    preview_slide5_desc: 'Une capture du Chrome Web Store montrant le popup et les détails de quota.',
    preview_slide6_title: 'Bannière X',
    preview_slide6_desc: 'Visuel social utilisant l’identité de Codex Quota Monitor.',
    preview_slide7_title: 'Bannière YouTube',
    preview_slide7_desc: 'Large bannière de chaîne préparée pour de futures vidéos et mises à jour communautaires.',
    preview_slide8_title: 'Miniature YouTube',
    preview_slide8_desc: 'Visuel de miniature pour de futurs guides et vidéos de lancement.',
    footer_github: 'GitHub',
  ...
  ar: {
    ...
    preview_title: 'Preview',
    preview_sub: 'شاهد كيف يظهر Codex Quota Monitor في المتصفح وضمن أصول Chrome Web Store.',
    preview_slide1_title: 'نظرة عامة على النافذة',
    preview_slide2_title: 'السمة الفاتحة',
    preview_slide3_title: 'لافتة المتجر',
    preview_slide_placeholder: 'معاينة لقطة شاشة',
    preview_slide4_desc: 'تصميم مضغوط لقائمة الإضافة في Chrome Web Store.',
    preview_slide4_title: 'البلاط الصغير',
    preview_slide3_desc: 'معاينة عريضة تعرض هوية الإضافة ونافذة الاستخدام.',
    ...
    preview_slide5_title: 'لقطة من المتجر',
    preview_slide5_desc: 'لقطة من Chrome Web Store تعرض النافذة المنبثقة وتفاصيل الحصة.',
    preview_slide6_title: 'لافتة X',
    preview_slide6_desc: 'تصميم اجتماعي يستخدم هوية Codex Quota Monitor.',
    preview_slide7_title: 'لافتة YouTube',
    preview_slide7_desc: 'لافتة قناة عريضة معدة لمقاطع فيديو وتحديثات مجتمعية مستقبلية.',
    preview_slide8_title: 'صورة مصغرة لـ YouTube',
    preview_slide8_desc: 'تصميم صورة مصغرة لشروحات ومقاطع إطلاق مستقبلية.',
  ...
  bn: {
    ...
    preview_title: 'Preview',
    preview_sub: 'ব্রাউজার এবং Chrome Web Store অ্যাসেটে Codex Quota Monitor কেমন দেখায় তা দেখুন।',
    preview_slide1_title: 'পপআপ ওভারভিউ',
    preview_slide2_title: 'লাইট থিম',
    preview_slide3_title: 'স্টোর মার্কি',
    preview_slide_placeholder: 'স্ক্রিনশট প্রিভিউ',
    preview_slide4_desc: 'Chrome Web Store তালিকার জন্য কমপ্যাক্ট আর্টওয়ার্ক।',
    preview_slide4_title: 'ছোট টাইল',
    preview_slide3_desc: 'একটি প্রশস্ত প্রিভিউ যেখানে এক্সটেনশনের পরিচয় এবং ব্যবহারের পপআপ দেখা যায়।',
    ...
    preview_slide5_title: 'স্টোর স্ক্রিনশট',
    preview_slide5_desc: 'Chrome Web Store-এর একটি স্ক্রিনশট যেখানে পপআপ এবং কোটা বিবরণ দেখা যায়।',
    preview_slide6_title: 'X ব্যানার',
    preview_slide6_desc: 'Codex Quota Monitor পরিচয় ব্যবহার করা সোশ্যাল ব্যানার আর্টওয়ার্ক।',
    preview_slide7_title: 'YouTube ব্যানার',
    preview_slide7_desc: 'ভবিষ্যৎ ভিডিও এবং কমিউনিটি আপডেটের জন্য প্রস্তুত প্রশস্ত চ্যানেল ব্যানার।',
    preview_slide8_title: 'YouTube থাম্বনেইল',
    preview_slide8_desc: 'ভবিষ্যৎ ওয়াকথ্রু এবং রিলিজ ভিডিওর জন্য থাম্বনেইল আর্টওয়ার্ক।',
  ...
  hi: {
    ...
    preview_title: 'Preview',
    preview_sub: 'देखें कि Codex Quota Monitor ब्राउज़र और Chrome Web Store एसेट्स में कैसा दिखता है।',
    preview_slide1_title: 'पॉपअप अवलोकन',
    preview_slide2_title: 'लाइट थीम',
    preview_slide3_title: 'स्टोर मार्की',
    preview_slide_placeholder: 'स्क्रीनशॉट प्रीव्यू',
    preview_slide4_desc: 'Chrome Web Store सूची के लिए कॉम्पैक्ट आर्टवर्क।',
    preview_slide4_title: 'छोटा टाइल',
    preview_slide3_desc: 'एक चौड़ा प्रीव्यू जिसमें एक्सटेंशन की पहचान और उपयोग पॉपअप दिखता है।',
    ...
    preview_slide5_title: 'स्टोर स्क्रीनशॉट',
    preview_slide5_desc: 'Chrome Web Store का स्क्रीनशॉट जिसमें पॉपअप और कोटा विवरण दिखते हैं।',
    preview_slide6_title: 'X बैनर',
    preview_slide6_desc: 'Codex Quota Monitor की पहचान का उपयोग करने वाला सोशल बैनर आर्टवर्क।',
    preview_slide7_title: 'YouTube बैनर',
    preview_slide7_desc: 'भविष्य के वीडियो और समुदाय अपडेट के लिए तैयार चौड़ा चैनल बैनर।',
    preview_slide8_title: 'YouTube थंबनेल',
    preview_slide8_desc: 'भविष्य के वॉकथ्रू और रिलीज वीडियो के लिए थंबनेल आर्टवर्क।',
  ...
  id: {
    ...
    preview_title: 'Preview',
    preview_sub: 'Lihat tampilan Codex Quota Monitor di browser dan aset Chrome Web Store.',
    preview_slide1_title: 'Ringkasan popup',
    preview_slide2_title: 'Tema terang',
    preview_slide3_title: 'Marquee toko',
    preview_slide_placeholder: 'Pratinjau screenshot',
    preview_slide4_desc: 'Artwork ringkas untuk listing ekstensi di Chrome Web Store.',
    preview_slide4_title: 'Tile kecil',
    preview_slide3_desc: 'Pratinjau lebar yang menampilkan identitas ekstensi dan popup penggunaan.',
    ...
    preview_slide5_title: 'Screenshot toko',
    preview_slide5_desc: 'Screenshot Chrome Web Store yang menampilkan popup dan detail kuota.',
    preview_slide6_title: 'Banner X',
    preview_slide6_desc: 'Artwork banner sosial menggunakan identitas Codex Quota Monitor.',
    preview_slide7_title: 'Banner YouTube',
    preview_slide7_desc: 'Banner kanal lebar yang disiapkan untuk video dan pembaruan komunitas mendatang.',
    preview_slide8_title: 'Thumbnail YouTube',
    preview_slide8_desc: 'Artwork thumbnail untuk panduan dan video rilis mendatang.',
  ...
  ru: {
    ...
    preview_title: 'Preview',
    preview_sub: 'Посмотрите, как Codex Quota Monitor выглядит в браузере и в материалах Chrome Web Store.',
    preview_slide1_title: 'Обзор всплывающего окна',
    preview_slide2_title: 'Светлая тема',
    preview_slide3_title: 'Баннер магазина',
    preview_slide_placeholder: 'Предпросмотр скриншота',
    preview_slide4_desc: 'Компактная графика для страницы расширения в Chrome Web Store.',
    preview_slide4_title: 'Малый блок',
    preview_slide3_desc: 'Широкий предпросмотр с айдентикой расширения и окном использования.',
    ...
    preview_slide5_title: 'Скриншот магазина',
    preview_slide5_desc: 'Скриншот Chrome Web Store с окном расширения и сведениями о квоте.',
    preview_slide6_title: 'Баннер X',
    preview_slide6_desc: 'Социальный баннер с айдентикой Codex Quota Monitor.',
    preview_slide7_title: 'Баннер YouTube',
    preview_slide7_desc: 'Широкий баннер канала для будущих видео и обновлений сообщества.',
    preview_slide8_title: 'Миниатюра YouTube',
    preview_slide8_desc: 'Миниатюра для будущих обзоров и видео о релизах.',
  ...
  zh_CN: {
    ...
    preview_title: '预览',
    preview_sub: '查看 Codex Quota Monitor 在浏览器和 Chrome Web Store 素材中的显示效果。',
    preview_slide1_title: '弹出窗口概览',
    preview_slide2_title: '浅色主题',
    preview_slide3_title: '商店横幅',
    preview_slide_placeholder: '截图预览',
    preview_slide4_desc: '用于 Chrome Web Store 扩展列表的紧凑宣传图。',
    preview_slide4_title: '小型图块',
    preview_slide3_desc: '展示扩展视觉标识和用量弹出窗口的宽幅预览。',
    preview_slide2_desc: '以清爽的浅色界面展示同样的配额详情。',
    preview_slide1_desc: '在一个紧凑弹出窗口中查看当前会话、每周限制、积分和重置时间。',
    preview_slide5_title: '商店截图',
    preview_slide5_desc: '展示弹出窗口和配额详情的 Chrome Web Store 截图。',
    preview_slide6_title: 'X 横幅',
    preview_slide6_desc: '使用 Codex Quota Monitor 视觉标识的社交横幅素材。',
    preview_slide7_title: 'YouTube 横幅',
    preview_slide7_desc: '为未来视频和社区更新准备的宽幅频道横幅。',
    preview_slide8_title: 'YouTube 缩略图',
    preview_slide8_desc: '为未来演示和发布视频准备的缩略图素材。',
