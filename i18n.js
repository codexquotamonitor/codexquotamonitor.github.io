...
const CQM_T = {
  ...
  en: {
    ...
    preview_sub: 'See how Codex Quota Monitor looks in the browser.',
    preview_slide1_title: 'Popup overview',
    preview_slide2_title: 'Light theme',
    preview_slide_placeholder: 'Screenshot preview',
    ...
    pp_s5_p2_html: 'The public website uses Google Analytics to measure aggregate traffic. This analytics applies to the website only, not to the browser extension.',
  ...
  pt_BR: {
    ...
    preview_sub: 'Veja como o Codex Quota Monitor aparece no navegador.',
    preview_slide1_title: 'Visão geral do popup',
    preview_slide2_title: 'Tema claro',
    preview_slide_placeholder: 'Prévia de captura de tela',
    ...
    pp_s5_p1: 'The extension does not integrate with any third-party services, SDKs, or APIs other than ChatGPT’s own usage endpoint, which you are already authenticated with.',
    pp_s5_p2_html: 'O site público usa Google Analytics para medir tráfego agregado. Essa análise se aplica apenas ao site, não à extensão do navegador.',
  ...
  es: {
    ...
    preview_title: 'Preview',
    preview_sub: 'Mira cómo se ve Codex Quota Monitor en el navegador.',
    preview_slide1_title: 'Vista general del popup',
    preview_slide2_title: 'Tema claro',
    preview_slide_placeholder: 'Vista previa de captura',
  ...
  fr: {
    ...
    preview_title: 'Preview',
    preview_sub: 'Découvrez l’apparence de Codex Quota Monitor dans le navigateur.',
    preview_slide1_title: 'Aperçu du popup',
    preview_slide2_title: 'Thème clair',
  ...
  ar: {
    ...
    preview_title: 'Preview',
    preview_sub: 'شاهد كيف يظهر Codex Quota Monitor في المتصفح.',
    preview_slide1_title: 'نظرة عامة على النافذة',
    preview_slide2_title: 'السمة الفاتحة',
    preview_slide_placeholder: 'معاينة لقطة شاشة',
  ...
  bn: {
    ...
    preview_title: 'Preview',
    preview_sub: 'ব্রাউজারে Codex Quota Monitor কেমন দেখায় তা দেখুন।',
    preview_slide1_title: 'পপআপ ওভারভিউ',
    preview_slide2_title: 'লাইট থিম',
    preview_slide_placeholder: 'স্ক্রিনশট প্রিভিউ',
  ...
  hi: {
    ...
    preview_title: 'Preview',
    preview_sub: 'देखें कि Codex Quota Monitor ब्राउज़र में कैसा दिखता है।',
    preview_slide1_title: 'पॉपअप अवलोकन',
    preview_slide2_title: 'लाइट थीम',
    preview_slide_placeholder: 'स्क्रीनशॉट प्रीव्यू',
  ...
  id: {
    ...
    preview_title: 'Preview',
    preview_sub: 'Lihat tampilan Codex Quota Monitor di browser.',
    preview_slide1_title: 'Ringkasan popup',
    preview_slide2_title: 'Tema terang',
    preview_slide_placeholder: 'Pratinjau screenshot',
  ...
  ru: {
    ...
    preview_title: 'Preview',
    preview_sub: 'Посмотрите, как Codex Quota Monitor выглядит в браузере.',
    preview_slide1_title: 'Обзор всплывающего окна',
    preview_slide2_title: 'Светлая тема',
    preview_slide_placeholder: 'Предпросмотр скриншота',
  ...
  zh_CN: {
    ...
    preview_title: '预览',
    preview_sub: '查看 Codex Quota Monitor 在浏览器中的显示效果。',
    preview_slide1_title: '弹出窗口概览',
    preview_slide2_title: '浅色主题',
    preview_slide_placeholder: '截图预览',
...
function cqmApplyLang(lang) {
  ...
  document.querySelectorAll('[data-localized-shot]').forEach(img => {
    img.src = `screenshots/store/localized/store-${lang}-${img.dataset.localizedShot}.png`;
  });
